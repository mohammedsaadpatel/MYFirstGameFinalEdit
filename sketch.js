...
var bgImg,stflogo;
var heartImage, powerImage, blastImage;
...
function preload(){
  ...
  player1sound = loadSound("sounds/throwknife.mp3");

  player2stand = loadImage("assets/boxer1.png");
  player2punch = loadImage("assets/boxer2.png");
  player2sound = loadSound("sounds/Fireball.mp3");
  ...
  if(GameState == 1){
    ...
    if(life1 <= 0 && life2 <= 0){
      ...
      swal(
        {
          title: `It's a TIE!!!`,
          text: "Play Again To Get your Winner!",
          imageUrl:
            "https://memegenerator.net/img/instances/51780113/its-a-tie-game-were-all-winners.jpg",
          imageSize: "150x150",
      ...
      swal(
        {
          ...
          text: "Hey you , Player 2 !! Better Luck Next Time",
          imageUrl:
            "https://leo-daniel.github.io/face-off/assets/images/winner-1.png",
          imageSize: "200x200",
          confirmButtonText: "Play Again"
        },
        function(isConfirm) {
    ...
    if(life1 <= 0 && life2 >= 0){
      ...
      swal(
        {
          title: `Congratulations!!!`,
          text: "Hey you , Player 1 !! Better Luck Next Time",
          imageUrl:
...
function spawnBlast(){
  ...
  blast = createSprite(fireball.x  ,fireball.y)
